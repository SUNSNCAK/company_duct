        ...
        <div class="container-fluid d-flex align-items-center">
          <div class="row">
            <div class="col-lg-7 col-md-10">
              <h1 class="display-2 text-white">สวัสดี <?php echo $admin->name; ?></h1>
              <p class="text-white mt-0 mb-5">นี่คือหน้าโปรไฟล์ของคุณ ปรับแต่งโปรไฟล์ได้ตามต้องการ และเปลี่ยนรหัสผ่านได้</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-8 order-xl-1">
            <div class="card bg-secondary shadow">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">ชื่อแอดมิน</label>
                          <input type="text" name="admin_name" value="<?php echo $admin->name; ?>" id="input-username" class="form-control form-control-alternative" ">
                      </div>
                    </div>
                    <div class=" col-lg-6">
                          <div class="form-group">
                            <label class="form-control-label" for="input-email">อีเมล์</label>
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            <input type="submit" id="input-email" name="ChangeProfile" class="btn btn-success form-control-alternative" value="เปลี่ยนแปลงข้อมูล">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <hr>
              <form method =" post">
                            <h6 class="heading-small text-muted mb-4">เปลี่ยนรหัสผ่าน</h6>
                            <div class="pl-lg-4">
                              <div class="row">
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="input-username">รหัสผ่านเก่า</label>
                                ...
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="input-email">รหัสผ่านใหม่</label>
                                ...
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <label class="form-control-label" for="input-email">ยืนยันรหัสผ่าน</label>
                                ...
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    <input type="submit" id="input-email" name="changePassword" class="btn btn-success form-control-alternative" value="เปลี่ยนรหัสผ่าน">
                                  </div>
                                </div>
                              </div>
                            </div>
